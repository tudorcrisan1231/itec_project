    ...
    <div class="fixed right-10 bottom-12 w-4/5 sm:w-80 h-80 text-xs text-gray-700 bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
        ...
        <div>
            ...
            <div class="flex items-center px-1 py-2  bg-gray-50 dark:bg-gray-700">
                <textarea id="chat" rows="1" class="block mx-2 p-1.5 pb-2 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..." wire:model="message"></textarea>
                <button type="submit" wire:click="sendMessage" class="inline-flex justify-center p-2 text-blue-600 rounded-full cursor-pointer hover:bg-blue-100 dark:text-blue-500 dark:hover:bg-gray-600">
